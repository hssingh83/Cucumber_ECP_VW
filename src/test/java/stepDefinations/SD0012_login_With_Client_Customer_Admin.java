...
public class SD0012_login_With_Client_Customer_Admin extends basePropertiesCucm {
    ...
    public void verify_that_login_successfully_with_empirix_business_analyst_user() throws Throwable {
 	    ...
 	    log.info("Verified that VoiceWatch Application login successfully with Client_Customer_Admin creadetial");
