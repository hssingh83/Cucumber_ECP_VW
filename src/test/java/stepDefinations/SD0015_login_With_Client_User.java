...
public class SD0015_login_With_Client_User extends basePropertiesCucm {
    ...
    public void verify_that_login_successfully_with_empirix_business_analyst_user() throws Throwable {
 	    ...
 	    log.info("Verified that VoiceWatch Application login successfully with Client_User creadetial");
