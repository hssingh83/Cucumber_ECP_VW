...
public class SD0009_login_With_Client_or_Partner_Client_Developer extends basePropertiesCucm {
	...
	@Given("^Initialize the Driver of the browser and provide the URL to login with Client_or_Partner_Client_Developer$")
    ...
    @When("^Login with username and password with Client_or_Partner_Client_Developer$")
    ...
    @Then("^Verify that login successfully with Client_or_Partner_Client_Developer$")
    public void verify_that_login_successfully_with_empirix_business_analyst_user() throws Throwable {
 	    ...
 	    log.info("Verified that VoiceWatch Application login successfully with Client_or_Partner_Client_Developer creadetial");
 	    log.info("Validate the requiment as Aceess Level= Empirix & Role=Business Analyst");   
    }

    @And("^Tab Availability Validation on the home screen while login with Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access home page with Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_home_page() throws Throwable {
    	pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
	    d.header();
    }

    @And("^Verify footer elements on the pages while access home page with Client_or_Partner_Client_Developer$")
 ...
 // Access to dashboard tab and validate elemets
    ...
    @When("^Navigate to dashboard tab with login as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the OverallPerfomance_section on the dashboard tab page as Client_or_Partner_Client_Developer$")
    ...
    @And("^Validate the elements on the activetest_section on the dashboard tab page as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access dashboard tab page as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_dashboard_tab_page() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access dashboard tab page as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Alert tab as Client_or_Partner_Client_Developer$")
    public void navigate_to_alert_tab() throws Throwable {
 	   By alertsTab=By.linkText("Alerts");
 	   driver.findElement(alertsTab).click();
    }

    @Then("^Validate the elements on the Alert tab page as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access alert tab pages as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_alert_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
 	   d.header();
    }

    @And("^Verify header elements on the pages while access alert tab pages as Client_or_Partner_Client_Developer$")
   ...
   // Access to Test Tab and validate elements  
    ...
    @When("^Navigate to Test tab as Client_or_Partner_Client_Developer$")
    public void navigate_to_test_tab() throws Throwable {
 	   By testTab=By.linkText("Tests");
 	   driver.findElement(testTab).click();
    }

    @Then("^Validate the elements on the Test tab page as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access Test tab pages as Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_test_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @And("^Verify footer elements on the pages while access Test tab pages as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_test_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @Then("^Validate element while Create a Test using Test create button as Client_or_Partner_Client_Developer$")
    public void validate_element_while_create_a_test_using_test_create_button() throws Throwable {
 	   pom005_VoiceWatch_Tests_Tab ts=new pom005_VoiceWatch_Tests_Tab(driver);
 	   ts.createTestbybutton();
    }
    
    @And("^Verify header elements on the pages while access Test tab while create test using button as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access Test tab while create test using button as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate element while Create a Test using Test create link as Client_or_Partner_Client_Developer$")
    public void validate_element_while_create_a_test_using_test_create_link() throws Throwable {
 	   pom005_VoiceWatch_Tests_Tab ts=new pom005_VoiceWatch_Tests_Tab(driver);
 	   ts.createTestbyLink();
    }

    @And("^Verify footer elements on the pages while access Test tab while create test using link as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access Test tab while create test using link as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Tag tab as Client_or_Partner_Client_Developer$")
    public void navigate_to_tag_tab() throws Throwable {
 	   By tagTab=By.linkText("Tags");
 	   driver.findElement(tagTab).click();	
    }

    @Then("^Validate the elements on the Tag tab page as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate element while Create a Tag using Tag create tag button as Client_or_Partner_Client_Developer$")
    public void validate_element_while_create_a_test_using_tag_create_button() throws Throwable {
 	   pom006_VoiceWatch_Tags_Tab tg=new pom006_VoiceWatch_Tags_Tab(driver);
 	   tg.createTagbybutton();
    }

    @Then("^Validate element while Create a Tag using Tag create link as Client_or_Partner_Client_Developer as Client_or_Partner_Client_Developer$")
    public void validate_element_while_create_a_test_using_tag_create_link() throws Throwable {
 	   pom006_VoiceWatch_Tags_Tab tg=new pom006_VoiceWatch_Tags_Tab(driver);
 	   tg.createNewTag();
    }

    @And("^Verify footer elements on the pages while access Tag tab pages as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab pagesas Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_tag_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access Tag tab while create tag using button as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_while_create_test_using_button() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab while create tag using button as Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_tag_tab_while_create_test_using_button() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access Tag tab while create tag using link as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_while_create_test_using_link() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab while create tag using link as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Script tab as Client_or_Partner_Client_Developer$")
    public void navigate_to_script_tab() throws Throwable {
 	   By scriptsTab=By.linkText("Scripts");
 	   driver.findElement(scriptsTab).click();		
    }

    @Then("^Validate the elements on the GoScriptBuilder tab page as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to GoScriptBuilder using createGSBbybutton as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the GoScriptBuilder while click createGSBbybutton as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the GoScriptBuilder while click createGSBbyLink as Client_or_Partner_Client_Developer$")
    public void validate_the_elements_on_the_goscriptbuilder_while_click_creategsbbylink() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.createGSBbyLink();
    }
    
    @When("^Navigate to GoScriptBuilder using createGSBbyLink as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access createGSBbyLink as Client_or_Partner_Client_Developer$")
    public void Verify_footer_elements_on_the_pages_while_access_createGSBbyLink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();;
    }

    @And("^Verify header elements on the pages while access createGSBbyLink as Client_or_Partner_Client_Developer$")
    public void Verify_header_elements_on_the_pages_while_access_createGSBbyLink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @When("^Navigate to ScriptUpload Tab as Client_or_Partner_Client_Developer$")
    ...
    @Then("^navigate to scriptUploadTab and validate the elements on that tab as Client_or_Partner_Client_Developer$")
    ...
    @Then("^validate the element while clicking createSUbybutton as Client_or_Partner_Client_Developer$")
    ...
    @Then("^validate the element while clicking createSUbyLink as Client_or_Partner_Client_Developer$")
    public void validate_the_element_while_clicking_createsubylink() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.createSUbyLink();
    }

    @When("^Navigate to CSV Tab as Client_or_Partner_Client_Developer$")
    ...
    @Then("^validate the element while clicking CSV Tab as Client_or_Partner_Client_Developer$")
    public void validate_the_element_while_clicking_csv_tab() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.csvTabValidation();
    }

    @And("^Verify footer elements on the pages while access Script tab pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access Script tab pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access scriptUploadTab pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access scriptUploadTab pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access createSUbybutton pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access createSUbybutton pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access createSUbyLink pages as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify header elements on the pages while access createSUbyLink pages as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Variable tab as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Variable using createVariableByButton as Client_or_Partner_Client_Developer$")
    ...
    @When("^Navigate to Variable using createVariableByLink as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the Variable tab page as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the Variable tab while click createVariableByButton as Client_or_Partner_Client_Developer$")
    ...
    @Then("^Validate the elements on the Variable tab while click createVariableByLink as Client_or_Partner_Client_Developer$")
    ...
    @And("^Verify footer elements on the pages while access Variable tab pages as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_variable_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Variable tab pages as Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_variable_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access createVariableByButton as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_creategsbbylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access createVariableByButton as Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_createvariablebybutton() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access createVariableByLink as Client_or_Partner_Client_Developer$")
    public void verify_footer_elements_on_the_pages_while_access_createvariablebylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access createVariableByLink as Client_or_Partner_Client_Developer$")
    public void verify_header_elements_on_the_pages_while_access_createvariablebylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @And("^Close the browser successfully which was login as Client_or_Partner_Client_Developer$")
