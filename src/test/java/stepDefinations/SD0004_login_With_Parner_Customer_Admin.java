...
public class SD0004_login_With_Parner_Customer_Admin extends basePropertiesCucm {
	...
	@Given("^Initialize the Driver of the browser and provide the URL to login with Partner_Customer_Admin$")
    ...
    @When("^Login with username and password with Partner_Customer_Admin$")
    public void login_with_username_and_password() throws Throwable {
    	...
    	ArrayList<String> data=d1.getData("login","PARTNER/Customer_Admin");
    ...
    @Then("^Verify that login successfully with Partner_Customer_Admin$")
    public void verify_that_login_successfully_with_empirix_business_analyst_user() throws Throwable {
 	    ...
 	    log.info("Verified that VoiceWatch Application login successfully with Partner_Customer_Admin creadetial");
 	    log.info("Validate the requiment as Aceess Level= Empirix & Role=Business Analyst");   
    }

    @And("^Tab Availability Validation on the home screen while login with Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access home page with Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_home_page() throws Throwable {
    	pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
	    d.header();
    }

    @And("^Verify footer elements on the pages while access home page with Partner_Customer_Admin$")
 ...
 // Access to dashboard tab and validate elemets
    ...
    @When("^Navigate to dashboard tab with login as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the OverallPerfomance_section on the dashboard tab page as Partner_Customer_Admin$")
    ...
    @And("^Validate the elements on the activetest_section on the dashboard tab page as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access dashboard tab page as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_dashboard_tab_page() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access dashboard tab page as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Alert tab as Partner_Customer_Admin$")
    public void navigate_to_alert_tab() throws Throwable {
 	   By alertsTab=By.linkText("Alerts");
 	   driver.findElement(alertsTab).click();
    }

    @Then("^Validate the elements on the Alert tab page as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access alert tab pages as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_alert_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);	
 	   d.header();
    }

    @And("^Verify header elements on the pages while access alert tab pages as Partner_Customer_Admin$")
   ...
   // Access to Test Tab and validate elements  
    ...
    @When("^Navigate to Test tab as Partner_Customer_Admin$")
    public void navigate_to_test_tab() throws Throwable {
 	   By testTab=By.linkText("Tests");
 	   driver.findElement(testTab).click();
    }

    @Then("^Validate the elements on the Test tab page as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access Test tab pages as Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_test_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @And("^Verify footer elements on the pages while access Test tab pages as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_test_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @Then("^Validate element while Create a Test using Test create button as Partner_Customer_Admin$")
    public void validate_element_while_create_a_test_using_test_create_button() throws Throwable {
 	   pom005_VoiceWatch_Tests_Tab ts=new pom005_VoiceWatch_Tests_Tab(driver);
 	   ts.createTestbybutton();
    }
    
    @And("^Verify header elements on the pages while access Test tab while create test using button as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access Test tab while create test using button as Partner_Customer_Admin$")
    ...
    @Then("^Validate element while Create a Test using Test create link as Partner_Customer_Admin$")
    public void validate_element_while_create_a_test_using_test_create_link() throws Throwable {
 	   pom005_VoiceWatch_Tests_Tab ts=new pom005_VoiceWatch_Tests_Tab(driver);
 	   ts.createTestbyLink();
    }

    @And("^Verify footer elements on the pages while access Test tab while create test using link as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access Test tab while create test using link as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Tag tab as Partner_Customer_Admin$")
    public void navigate_to_tag_tab() throws Throwable {
 	   By tagTab=By.linkText("Tags");
 	   driver.findElement(tagTab).click();	
    }

    @Then("^Validate the elements on the Tag tab page as Partner_Customer_Admin$")
    ...
    @Then("^Validate element while Create a Tag using Tag create tag button as Partner_Customer_Admin$")
    public void validate_element_while_create_a_test_using_tag_create_button() throws Throwable {
 	   pom006_VoiceWatch_Tags_Tab tg=new pom006_VoiceWatch_Tags_Tab(driver);
 	   tg.createTagbybutton();
    }

    @Then("^Validate element while Create a Tag using Tag create link as Partner_Customer_Admin as Partner_Customer_Admin$")
    public void validate_element_while_create_a_test_using_tag_create_link() throws Throwable {
 	   pom006_VoiceWatch_Tags_Tab tg=new pom006_VoiceWatch_Tags_Tab(driver);
 	   tg.createNewTag();
    }

    @And("^Verify footer elements on the pages while access Tag tab pages as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab pagesas Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_tag_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access Tag tab while create tag using button as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_while_create_test_using_button() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab while create tag using button as Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_tag_tab_while_create_test_using_button() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access Tag tab while create tag using link as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_tag_tab_while_create_test_using_link() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Tag tab while create tag using link as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Script tab as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the GoScriptBuilder tab page as Partner_Customer_Admin$")
    ...
    @When("^Navigate to GoScriptBuilder using createGSBbybutton as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the GoScriptBuilder while click createGSBbybutton as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the GoScriptBuilder while click createGSBbyLink as Partner_Customer_Admin$")
    ...
    @When("^Navigate to GoScriptBuilder using createGSBbyLink as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access createGSBbyLink as Partner_Customer_Admin$")
    public void Verify_footer_elements_on_the_pages_while_access_createGSBbyLink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();;
    }

    @And("^Verify header elements on the pages while access createGSBbyLink as Partner_Customer_Admin$")
    public void Verify_header_elements_on_the_pages_while_access_createGSBbyLink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @When("^Navigate to ScriptUpload Tab as Partner_Customer_Admin$")
    ...
    @Then("^navigate to scriptUploadTab and validate the elements on that tab as Partner_Customer_Admin$")
    public void navigate_to_scriptuploadtab_and_validate_the_elements_on_that_tab() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.scriptUploadTabValidation();
    }

    @Then("^validate the element while clicking createSUbybutton as Partner_Customer_Admin$")
    ...
    @Then("^validate the element while clicking createSUbyLink as Partner_Customer_Admin$")
    public void validate_the_element_while_clicking_createsubylink() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.createSUbyLink();
    }

    @When("^Navigate to CSV Tab as Partner_Customer_Admin$")
    ...
    @Then("^validate the element while clicking CSV Tab as Partner_Customer_Admin$")
    public void validate_the_element_while_clicking_csv_tab() throws Throwable {
 	   pom007_VoiceWatch_Script_Tabs sc=new pom007_VoiceWatch_Script_Tabs(driver);
 	   sc.csvTabValidation();
    }

    @And("^Verify footer elements on the pages while access Script tab pages as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access Script tab pages as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access scriptUploadTab pages as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access scriptUploadTab pages as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access createSUbybutton pages as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access createSUbybutton pages as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access createSUbyLink pages as Partner_Customer_Admin$")
    ...
    @And("^Verify header elements on the pages while access createSUbyLink pages as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Variable tab as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Variable using createVariableByButton as Partner_Customer_Admin$")
    ...
    @When("^Navigate to Variable using createVariableByLink as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the Variable tab page as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the Variable tab while click createVariableByButton as Partner_Customer_Admin$")
    ...
    @Then("^Validate the elements on the Variable tab while click createVariableByLink as Partner_Customer_Admin$")
    ...
    @And("^Verify footer elements on the pages while access Variable tab pages as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_variable_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Variable tab pages as Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_variable_tab_pages() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access createVariableByButton as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_creategsbbylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access createVariableByButton as Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_createvariablebybutton() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }

    @And("^Verify footer elements on the pages while access createVariableByLink as Partner_Customer_Admin$")
    public void verify_footer_elements_on_the_pages_while_access_createvariablebylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access createVariableByLink as Partner_Customer_Admin$")
    public void verify_header_elements_on_the_pages_while_access_createvariablebylink() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.header();
    }
    
    @And("^Close the browser successfully which was login as Partner_Customer_Admin$")
