...
public class SD0006_login_With_Partner_Enhanced_User extends basePropertiesCucm {
    ...
    public void verify_that_login_successfully_with_empirix_business_analyst_user() throws Throwable {
 	    ...
 	    log.info("Verified that VoiceWatch Application login successfully with Partner_Enhanced_User creadetial");
