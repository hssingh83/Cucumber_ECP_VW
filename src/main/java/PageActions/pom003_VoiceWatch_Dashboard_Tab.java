...
public class pom003_VoiceWatch_Dashboard_Tab {
 ...
 //   By activetestNameColoum=By.xpath("//*[@id=\"activetest\"]/table/tbody/tr[1]/th[2]/div/span[1]");
  ...
  //  By activetestFailedColoumn=By.xpath("//*[@id=\\\"activetest\\\"]/table/tbody/tr[1]/th[3]/div/span[1]");
	...
	public void OverallPerfomance_section_dashboard() throws InterruptedException {	
		
	//	Thread.sleep(10000);
	//	driver.findElement(dashBoardTab).click();
		
		Assert.assertTrue(driver.findElement(overAllPerformanceLabel).isDisplayed());
		log.info("Verified that 'Overall Performance' displayed under dashoboard tab");
		Assert.assertEquals(driver.findElement(overAllPerformanceLabel).getText(), "Overall Performance");		
		log.info("Verified that 'Overall Performance' Text appeared under dashboard Tab");	
		
		Assert.assertTrue(driver.findElement(failledCallsLabel).isDisplayed());
		log.info("Verified that 'Failed Calls' dislayed under Overall Performance section in dashboard Tab");
		Assert.assertEquals(driver.findElement(failledCallsLabel).getText(), "Failed Calls");		
		log.info("Verified that 'Failed Calls' comtain under Overall Performance section in dashboard Tab");	
		
		Assert.assertTrue(driver.findElement(passedCallsLabels).isDisplayed());
		log.info("Verified that 'Passed Calls' dislayed under Overall Performance section in dashboard Tab");
		Assert.assertEquals(driver.findElement(failledCallsLabel).getText(), "Failed Calls");		
		log.info("Verified that 'Passed Calls' comtain under Overall Performance section in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(alertslabels).isDisplayed());
		log.info("Verified that 'Alerts' dislayed under Overall Performance section in dashboard Tab");
		Assert.assertEquals(driver.findElement(failledCallsLabel).getText(), "Failed Calls");		
		log.info("Verified that 'Alerts' comtain under Overall Performance section in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(overallDownloadCSVbutton).isDisplayed());
		log.info("Verified that 'Download CSV' button dislayed under Overall Performance section in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(overallDownloadCSVbutton).isEnabled());
		log.info("Verified that 'Download CSV' button enabled under Overall Performance section in dashboard Tab");
		
		Assert.assertEquals(driver.findElement(overallDownloadCSVbutton).getText(), "Download CSV");		
		log.info("Verified that 'Download CSV' test appeared on the button under Overall Performance section in dashboard Tab");
...
public void activetest_section_dashboard() {	
		...
		log.info("Verified that 'Tests' Text appeared under activetest section in dashboard Tab");	
		
		Assert.assertTrue(driver.findElement(activetestFilter).isDisplayed());
		log.info("Verified that 'filter' appeared under activetest section section in dashboard Tab");
		/*Assert.assertEquals(driver.findElement(failledCallsLabel).getText(), "Failed Calls");		
		log.info("Verified that 'Failed Calls' comtain under activetest section in dashboard Tab");	*/
		
		Assert.assertTrue(driver.findElement(activetestLastCallColoum).isDisplayed());
		log.info("Verified that 'Passed Calls' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestLastCallColoum).getText(), "Last Call");		
		log.info("Verified that 'Last Call' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestNameColoum).isDisplayed());
		log.info("Verified that 'Name' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestNameColoum).getText(), "Name");		
		log.info("Verified that 'Name' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestFailedColoumn).isDisplayed());
		log.info("Verified that 'Failed' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestFailedColoumn).getText(), "Failed");		
		log.info("Verified that 'Failed' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestPassedColoumn).isDisplayed());
		log.info("Verified that 'Passed ' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestPassedColoumn).getText(), "Passed");		
		log.info("Verified that 'Passed' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestAlertsColoum).isDisplayed());
		log.info("Verified that 'Alerts' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestAlertsColoum).getText(), "Alerts");		
		log.info("Verified that 'Alerts' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestGraphResultsColoum).isDisplayed());
		log.info("Verified that 'Graph Results' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestGraphResultsColoum).getText(), "Graph Results");		
		log.info("Verified that 'Graph Results' coloumn under Tests table in dashboard Tab");
		
		Assert.assertTrue(driver.findElement(activetestNotificationPresenColoum).isDisplayed());
		log.info("Verified that 'Notification Present' dislayed under activetest section section in dashboard Tab");
		Assert.assertEquals(driver.findElement(activetestNotificationPresenColoum).getText(), "Notification Present");		
		log.info("Verified that 'Notification Present' coloumn under Tests table in dashboard Tab");
	...
	log.info("VoiceWatch Dashboard Page verification Started");
	
/*	Assert.assertTrue(driver.findElement(dashBoardTab).isDisplayed());
	log.info("Verified that 'Dashboard Tab' appeared on the VoiceWatch dashoboard");	
	Assert.assertTrue(driver.findElement(dashBoardTab).isEnabled());
	log.info("Verified that 'Dashboard Tab' enabled on the VoiceWatch dashoboard");	*/
	...
	log.info("Verified that 'Alerts Tab' appeared on the VoiceWatch dashboard");	
	Assert.assertTrue(driver.findElement(alertsTab).isEnabled());
	log.info("Verified that 'Alerts Tab' enabled on the VoiceWatch dashboard");	
	Assert.assertFalse(driver.getCurrentUrl().contains("alerts"));
	log.info("Verified that 'Alerts Tab' not selected on the VoiceWatch dashboard");
	
	
	Assert.assertTrue(driver.findElement(testTab).isDisplayed());
	log.info("Verified that 'Tests Tab' appeared on the VoiceWatch dashboard");	
	Assert.assertTrue(driver.findElement(testTab).isEnabled());
	log.info("Verified that 'Tests Tab' enabled on the VoiceWatch dashboard");	
	Assert.assertFalse(driver.getCurrentUrl().contains("tests"));
	log.info("Verified that 'Tests Tab' not selected on the VoiceWatch dashboard");*/
	...
	log.info("Verified that 'Variables Tab' appeared on the VoiceWatch dashboard");
	Assert.assertTrue(driver.findElement(variablesTab).isEnabled());
	log.info("Verified that 'Variables Tab' enabled on the VoiceWatch dashboard");
	Assert.assertFalse(driver.getCurrentUrl().contains("variables"));
	log.info("Verified that 'Variable Tab' not selected on the VoiceWatch dashboard");
	*/
	...
	log.info("Verified that 'Notifications Tab' appeared on the VoiceWatch dashboard");
	Assert.assertTrue(driver.findElement(notificationsTab).isEnabled());
	log.info("Verified that 'Notifications Tab' enabled on the VoiceWatch dashboard");
	Assert.assertFalse(driver.getCurrentUrl().contains("notifi"));
	log.info("Verified that 'Notifications Tab' not selected on the VoiceWatch dashboard");*/
...
//	Assert.assertTrue(driver.findElements(hammersTab).isEmpty());
	...
	/*public void header() {
		...
		log.info("Verified that 'Empirix Logo' appeared on top left corner VoiceWatch dashboard");
		
		Assert.assertTrue(driver.findElement(headerEmpirixLogo).isEnabled());
		log.info("Verified that 'Empirix Logo' enabled on top left corner VoiceWatch dashboard");
		
		Assert.assertTrue(driver.findElement(headerEmpirixLebel).isDisplayed());
		log.info("Verified that 'Empirix Lebel' appeared on top left corner VoiceWatch dashboard");
		
		Assert.assertEquals(driver.findElement(headerEmpirixLebel).getText(), "EMPIRIX");		
		log.info("Verified that 'EMPIRIX' Text appeared on top left corner VoiceWatch dashboard");	
		
		Assert.assertTrue(driver.findElement(headerEmpirixLogo).isEnabled());
		log.info("Verified that 'Empirix label' enabled on top left corner VoiceWatch dashboard");
		
		Assert.assertTrue(driver.findElement(headerApplicationName).isDisplayed());		
		log.info("Verified that 'Application Name' appeared on top left corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(headerApplicationName).isEnabled());
		log.info("Verified that 'Application Name' enabled on top left corner VoiceWatch dashboard");
		
		Assert.assertEquals(driver.findElement(headerApplicationName).getText(), "VoiceWatch");		
		log.info("Verified that 'VoiceWatch' Text appeared on top left corner VoiceWatch dashboard");	
		
		
		Assert.assertTrue(driver.findElement(headerDropdown).isDisplayed());
		log.info("Verified that dropdown appeared on top right corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(headerDropdown).isEnabled());
		log.info("Verified that dropdwon enabled on top right corner VoiceWatch dashboard");
		
		Assert.assertTrue(driver.findElement(headerContactUs).isDisplayed());
		log.info("Verified that 'ContacUs' appeared on top right corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(headerContactUs).isEnabled());
		log.info("Verified that 'ContacUs' enabled on top right corner VoiceWatch dashboard");
		Assert.assertEquals(driver.findElement(headerContactUs).getText(), "Contact Us");		
		log.info("Verified that 'Contact Us' Text appeared on top left corner VoiceWatch dashboard");	
		
		
		Assert.assertTrue(driver.findElement(headerHelp).isDisplayed());
		log.info("Verified that 'Help' appeared on top right corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(headerHelp).isEnabled());
		log.info("Verified that 'help' enabled on top right corner VoiceWatch dashboard");
		
		Assert.assertEquals(driver.findElement(headerHelp).getText(), "Help");		
		log.info("Verified that 'Help' Text appeared on top left corner VoiceWatch dashboard");	
...
public void footer() {
		...
		log.info("Verified that 'BackToTop link' appeared on bottom right corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(footerBackToTop).isEnabled());
		log.info("Verified that 'BackToTop link' enabled on bottom right corner VoiceWatch dashboard");
		Assert.assertEquals(driver.findElement(footerBackToTop).getText(), "Back to top");		
		log.info("Verified that 'Back to top' Text appeared on top left corner VoiceWatch dashboard");	
		
		
		Assert.assertTrue(driver.findElement(footerVersion).isDisplayed());		
		log.info("Verified that 'Version' Text appeared on bottom left corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(footerVersion).isEnabled());
		log.info("Verified that 'Version' test enabled on right corner VoiceWatch dashboard");
		Assert.assertEquals(driver.findElement(footerVersion).getText(), "Version");		
		log.info("Verified that 'Version' Text appeared on top left corner VoiceWatch dashboard");	
		
		
		
		Assert.assertTrue(driver.findElement(footerVersionNumber).isDisplayed());
		log.info("Verified that 'Version Number' appeared on bottom left corner VoiceWatch dashboard");		
		Assert.assertTrue(driver.findElement(footerVersionNumber).isEnabled());
		log.info("Verified that 'Version Number' enabled on right corner VoiceWatch dashboard");
		Assert.assertEquals(driver.findElement(footerVersionNumber).getText().contains("26.0"), true);		
		log.info("Verified that 'Version contain 26.0' appeared on top left corner VoiceWatch dashboard");	
		
		
		
		Assert.assertTrue(driver.findElement(footerEmpirixLebel).isDisplayed());
		log.info("Verified that 'Empirix Label' appeared on bottom left corner VoiceWatch dashboard");
		Assert.assertTrue(driver.findElement(footerEmpirixLebel).isEnabled());
		log.info("Verified that 'Empirix Label' enabled on right corner VoiceWatch dashboard");
...
/*public void tagTab() {
		...
		if (driver.findElements(tagTab).isEmpty()) {
			...
			log.info("Verified that 'Tags Tab' is not appearing on the VoiceWatch dashboard");
...
public void scriptsTab() {
	...
	if (driver.findElements(scriptsTab).isEmpty()) {
		...
		log.info("Verified that 'Scripts Tab' is not appearing on the VoiceWatch dashboard");
...
public void usersTab() {
	...
	if (driver.findElements(usersTab).isEmpty()) {
		...
		log.info("Verified that 'Users Tab' is not appearing on the VoiceWatch dashboard");
	...
	public void clientsTab() {
		...
		if (driver.findElements(clientsTab).isEmpty()) {
			...
			log.info("Verified that 'Clients Tab' is not appearing on the VoiceWatch dashboard");
			
						
		}else
		
		{
			log.info("Verified that 'Clients Tab' appeared on the VoiceWatch dashboard");
	...
	public void auditTab() {
		...
		if (driver.findElements(auditTab).isEmpty()) {
			...
			log.info("Verified that 'Audit Tab' is not appearing on the VoiceWatch dashboard");
			
						
		}else
		
		{
			log.info("Verified that 'Audit Tab' appeared on the VoiceWatch dashboard");
	...
	public void adminTab() {
		...
		if (driver.findElements(adminsTab).isEmpty()) {
			...
			log.info("Verified that 'Admin Tab' is not appearing on the VoiceWatch dashboard");
			
						
		}else
		
		{
			log.info("Verified that 'Admin Tab' appeared on the VoiceWatch dashboard");
		...
		if (driver.findElements(hammersTab).isEmpty()) {
			...
			log.info("Verified that 'Hammers Tab' is not appearing on the VoiceWatch dashboard");
			
						
		}else
		
		{
			log.info("Verified that 'Hammers Tab' appeared on the VoiceWatch dashboard");
		...
		public void selectedTab() {
			...
			if (driver.getCurrentUrl().contains("admin_dash")) {	
				...
				log.info("Verified that 'Admin Tab' selected on the VoiceWatch application");

							
			}else
			
			{
				log.info("Verified that 'Dashboard Tab' selected on the VoiceWatch application");
