...
public class SD0003_login_With_Empirix_Business_Analyst extends basePropertiesCucm {
 ...
 // Access to dashboard tab and validate elemets
   ...
   // Access to Test Tab and validate elements  
    ...
    public void navigate_to_hammer_tab_as_empirix_business_analyst() throws Throwable {
    ...
    public void navigate_to_hammer_using_createhammerbybutton_as_empirix_business_analyst() throws Throwable {
    ...
    public void navigate_to_hammer_using_createhammerbylink_as_empirix_business_analyst() throws Throwable {
    	   pom009_VoiceWatch_Hammers_Tab hm=new pom009_VoiceWatch_Hammers_Tab(driver);
    	   hm.createHammerByLink();
    }

    @Then("^Validate the elements on the Hammer tab page as Empirix Business analyst$")
    public void validate_the_elements_on_the_hammer_tab_page_as_empirix_business_analyst() throws Throwable {
    	pom009_VoiceWatch_Hammers_Tab hm=new pom009_VoiceWatch_Hammers_Tab(driver);
    ...
    public void validate_the_elements_on_the_hammer_tab_while_click_createhammerbybutton_as_empirix_business_analyst() throws Throwable {
    	  pom009_VoiceWatch_Hammers_Tab hm=new pom009_VoiceWatch_Hammers_Tab(driver);
   	   hm.createHammerByButton();
    }

    @Then("^Validate the elements on the Hammer tab while click createHammerByLink as Empirix Business analyst$")
    public void validate_the_elements_on_the_hammer_tab_while_click_createhammerbylink_as_empirix_business_analyst() throws Throwable {
 	   pom009_VoiceWatch_Hammers_Tab hm=new pom009_VoiceWatch_Hammers_Tab(driver);
 	   hm.createHammerByLink();
    }

    @And("^Verify footer elements on the pages while access Hammer tab pages as Empirix Business analyst$")
    public void verify_footer_elements_on_the_pages_while_access_hammer_tab_pages_as_empirix_business_analyst() throws Throwable {
 	   pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
 	   d.footer();
    }

    @And("^Verify header elements on the pages while access Hammer tab pages as Empirix Business analyst$")
    public void verify_header_elements_on_the_pages_while_access_hammer_tab_pages_as_empirix_business_analyst() throws Throwable {
       pom002_VoiceWatch_Home_Page d=new pom002_VoiceWatch_Home_Page(driver);
   	   d.header();
    }
